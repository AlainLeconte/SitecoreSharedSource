<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="LanguageMigration.aspx.cs" Inherits="Sitecore.SharedSource.LanguageMigrationTool.Web.LanguageMigration" %>
                                ...
                                <div class="col-pad">
                                    <div class="language-form language-form-validation">
                                        ...
                                        <div>
                                            <label for=""></label>
                                            <p class="description">
                                                (Note: Selection 'Remove Target' will delete all the target language versions. 
                                        This will not perform any kind of migration.)
                                            </p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            &nbsp;&nbsp;OR
                                            <!-- added '&nbsp;' to give some space before 'OR' -->
                                            <span class="all-other-languages-trigger">
                                                <!-- Added a wrapper so we can style and align this specificaly in the CSS -->
